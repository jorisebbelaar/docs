...
description: "Learn how to implement concurrent processing with ConcurrentNode to improve performance by running independent operations simultaneously."
---
...
<CardGroup cols={2}>
  ...
  <Card title="Guardrails Processing" icon="shield">
    Running multiple guardrails or safety checks simultaneously
  </Card>
</CardGroup>
